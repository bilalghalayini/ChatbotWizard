...
<configuration>
    ...
    <system.applicationHost>
        ...
        <sites>
            ...
            <site name="DynamicsWebApi" id="2">
                <application path="/" applicationPool="Clr4IntegratedAppPool">
                    <virtualDirectory path="/" physicalPath="C:\GitHub\DynamicsWebApi\DynamicsWebApi" />
                </application>
                <bindings>
                    <binding protocol="http" bindingInformation="*:51524:localhost" />
                </bindings>
            </site>
            <siteDefaults>
